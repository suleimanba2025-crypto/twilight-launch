...
export const translations: Translations = {
  ...
  hero_title_3: { en: 'Partner in Syria & Oman.', ar: 'للنمو في سوريا وعمان' },
  ...
  about_years: { en: 'Years in Region', ar: 'سنوات في المنطقة' },
  about_title: { en: 'Based in the heart of', ar: 'من قلب' },
  about_city: { en: 'Syria & Oman', ar: 'سوريا وعمان' },
  ...
  about_local_dna_desc: { en: 'Understanding the local consumer', ar: 'فهم عميق للمستهلك المحلي' },
  ...
  service_meta_detail: { en: 'Advanced pixel tracking, CAPI implementation, and hyper-local creative testing. We build high-converting ad funnels that guide consumers in Syria & Oman from initial awareness to final purchase.', ar: 'تتبع البكسل المتقدم، تنفيذ CAPI، واختبار تصاميم محلية. نقوم ببناء مسارات إعلانية عالية التحويل توجه المستهلكين في سوريا وعمان للشراء.' },
  ...
  cases_hero_subtitle: { en: 'Explore our latest work and visual designs for brands in Syria & Oman.', ar: 'اكتشف أحدث أعمالنا وتصاميمنا البصرية للعلامات التجارية في سوريا وعمان.' },
  ...
  footer_desc: { en: "Start growing with the region's best agency.", ar: 'ابدأ النمو مع أفضل وكالة في المنطقة.' },
  footer_nav: { en: 'Nav', ar: 'التنقل' },
  footer_connect: { en: 'Connect', ar: 'تواصل' },
  footer_privacy: { en: 'Privacy', ar: 'الخصوصية' },
  footer_address: { en: 'Syria & Oman', ar: 'سوريا وعمان' },
  ...
  why_p: { 
    en: 'We combine data science with creative intuition to deliver high-performance campaigns that drive actual revenue growth for businesses in Syria & Oman.', 
  ...
  why_item3_desc: { en: 'Deep understanding of local consumer behavior and cultural nuances in Syria & Oman.', ar: 'فهم عميق لسلوك المستهلك المحلي والفوارق الثقافية الدقيقة في سوريا وعمان.' },
  ...
  case_ahlain_starting: { en: 'Ahlain Travel needed a visual identity for their holiday packages that resonates with the adventurous spirit in the region.', ar: 'كانت أهلين ترافيل بحاجة إلى هوية بصرية لباقات عطلاتهم تحاكي روح المغامرة في المنطقة.' },
  ...
  case_ahlain_impact: { en: 'The new designs unified the brand look across social media and physical branches.', ar: 'وحدت التصاميم الجديدة مظهر العلامة التجارية عبر وسائل التواصل الاجتماعي والفروع الفعلية.' },
  ...
  case_ms_solution: { en: 'We deployed a high-conversion lead generation funnel specifically targeted at the business sector in Syria & Oman.', ar: 'قمنا بإطلاق مسار تحويل لتوليد العملاء يستهدف قطاع الأعمال في سوريا وعمان بشكل مباشر ودقيق.' },
  ...
  case_awtar_starting: { en: 'Awtar Al sultanah aimed to capture high-value interest for their premium services in a highly competitive niche.', ar: 'هدفت أوتار السلطنة إلى جذب اهتمام عالي القيمة لخدماتها المتميزة في قطاع تنافسي للغاية.' },
  ...
  case_arabicoud_starting: { en: 'Arabic Oud entered the luxury perfume market, needing a digital debut that matches their aromatic excellence.', ar: 'دخلت أربيك عود سوق العطور الفاخرة، وكانت بحاجة إلى ظهور رقمي يوازي تميز عطورها.' },
  ...
  case_itzel_starting: { en: 'Itzel needed to elevate its brand positioning to effectively reach and resonate with a premium target audience.', ar: 'كانت اتزل بحاجة إلى رفع مستوى تموضع علامتها التجارية للوصول الفعال والتأثير في جمهور مستهدف متميز.' },
